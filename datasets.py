...
class LFM1bDataset(data.Dataset):
    def __init__(
        ...
        self.train_data, tr_start_idx, tr_end_idx = utils.load_train_data(
            os.path.join(out_data_dir, "train_data.csv"), n_items
        )
        ...
        (
            ...
            vad_start_idx,
            vad_end_idx,
        ) = utils.load_tr_te_data(
            os.path.join(out_data_dir, "validation_data_tr.csv"),
            os.path.join(out_data_dir, "validation_data_te.csv"),
            n_items,
        )
        (
            self.test_data_tr,
            ...
            os.path.join(out_data_dir, "test_data_tr.csv"),
            os.path.join(out_data_dir, "test_data_te.csv"),
            n_items,
        )
